...
import com.ssafy.c204_be_judge.judge.domain.Failure;
...
public class JudgeService {
    ...
    public JudgeResult startWorker() {
        ...
        sendToAPIServer(message.memberId(), JudgeResultMessage.from(result, message.submittedAt()));
        return result;
    }
    ...
    private void sendToAPIServer(Long memberId, JudgeResultMessage message) {
        restClient.post()
    ...
    record JudgeResultMessage (
        ...
        public static JudgeResultMessage from(JudgeResult result, LocalDateTime submittedAt) {
